...
class TextInput(_message.Message):
    ...
    class _TypeEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[TextInput._Type.ValueType], _builtins.type):
        ...
        """A normal text input. Renders a native <input type="text">."""
        ...
        """
        EMAIL: TextInput._Type.ValueType  # 2
        """An email input. Renders a native <input type="email">."""
        URL: TextInput._Type.ValueType  # 3
        """A URL input. Renders a native <input type="url">."""
        PHONE: TextInput._Type.ValueType  # 4
        """A phone number input. Renders a native <input type="tel">."""
        SEARCH: TextInput._Type.ValueType  # 5
        """A search input. Renders a native <input type="search">."""
    ...
    Renders a native <input type="password">.
    """
    EMAIL: TextInput.Type.ValueType  # 2
    """An email input. Renders a native <input type="email">."""
    URL: TextInput.Type.ValueType  # 3
    """A URL input. Renders a native <input type="url">."""
    PHONE: TextInput.Type.ValueType  # 4
    """A phone number input. Renders a native <input type="tel">."""
    SEARCH: TextInput.Type.ValueType  # 5
    """A search input. Renders a native <input type="search">."""
    ...
    validate_regex: _builtins.str
    validate_message: _builtins.str
    @_builtins.property
    ...
    _WhichOneofArgType__validate_message: _TypeAlias = _typing.Literal["_validate_message", b"_validate_message"]  # noqa: Y015
    _WhichOneofReturnType__validate_regex: _TypeAlias = _typing.Literal["validate_regex"]  # noqa: Y015
    _WhichOneofArgType__validate_regex: _TypeAlias = _typing.Literal["_validate_regex", b"_validate_regex"]  # noqa: Y015
    ...
    @_typing.overload
    def WhichOneof(self, oneof_group: _WhichOneofArgType__validate_message) -> _WhichOneofReturnType__validate_message | None: ...
    @_typing.overload
    def WhichOneof(self, oneof_group: _WhichOneofArgType__validate_regex) -> _WhichOneofReturnType__validate_regex | None: ...
    @_typing.overload
